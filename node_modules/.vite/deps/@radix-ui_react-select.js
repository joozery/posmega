...
import {
  useId
} from "./chunk-HLZT5VAK.js";
import {
  DismissableLayer,
  Portal,
  VISUALLY_HIDDEN_STYLES
} from "./chunk-4HZSTE7U.js";
import {
  useCallbackRef
} from "./chunk-6UJTSK5N.js";
import {
  clamp
} from "./chunk-6ZMM2PAV.js";
import {
  useDirection
} from "./chunk-IZMRUYYR.js";
import {
  createCollection
} from "./chunk-6H3QY3DA.js";
import {
  usePrevious,
  useSize
} from "./chunk-JYBUY2P7.js";
import {
  composeEventHandlers,
  createContextScope,
  useControllableState,
  useLayoutEffect2
} from "./chunk-G5GJFI4K.js";
import {
  Primitive
} from "./chunk-LUYOEXGV.js";
import {
  createSlot,
  useComposedRefs
...
var Select = (props) => {
  ...
  const [trigger, setTrigger] = React15.useState(null);
  const [valueNode, setValueNode] = React15.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React15.useState(false);
  ...
  const triggerPointerDownPosRef = React15.useRef(null);
  const isFormControl = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React15.useState(/* @__PURE__ */ new Set());
      ...
      children: [
        (0, import_jsx_runtime4.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime4.jsx)(
          SelectNativeOptionsProvider,
          {
            ...
            onNativeOptionAdd: React15.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React15.useCallback((option) => {
...
var SelectTrigger = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React15.useRef("touch");
...
var SelectValue = React15.forwardRef(
  (props, forwardedRef) => {
...
var SelectIcon = React15.forwardRef(
  (props, forwardedRef) => {
...
var SelectContent = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    const [fragment, setFragment] = React15.useState();
    useLayoutEffect2(() => {
...
var SelectContentImpl = React15.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = React15.useState(null);
    const [selectedItemText, setSelectedItemText] = React15.useState(
      null
    );
    const getItems = useCollection(__scopeSelect);
    const [isPositioned, setIsPositioned] = React15.useState(false);
    const firstValidItemFoundRef = React15.useRef(false);
    React15.useEffect(() => {
      if (content)
        return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst2 = React15.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React15.useCallback(
    ...
    const itemRefCallback = React15.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React15.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    const itemTextRefCallback = React15.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
...
var SelectItemAlignedPosition = React15.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME2, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME2, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React15.useState(null);
  const [content, setContent] = React15.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection(__scopeSelect);
  const shouldExpandOnScrollRef = React15.useRef(false);
  const shouldRepositionRef = React15.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React15.useCallback(() => {
  ...
  const handleScrollButtonChange = React15.useCallback(
    (node) => {
...
var SelectPopperPosition = React15.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React15.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, nonce, ...viewportProps } = props;
    const contentContext = useSelectContentContext(VIEWPORT_NAME, __scopeSelect);
    const viewportContext = useSelectViewportContext(VIEWPORT_NAME, __scopeSelect);
    const composedRefs = useComposedRefs(forwardedRef, contentContext.onViewportChange);
    const prevScrollTopRef = React15.useRef(0);
...
var SelectGroup = React15.forwardRef(
  (props, forwardedRef) => {
...
var SelectItem = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textValue, setTextValue] = React15.useState(textValueProp ?? "");
    ...
    return (0, import_jsx_runtime4.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React15.useCallback((node) => {
...
var SelectItemText = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React15.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React15.useMemo(
...
var SelectItemIndicator = React15.forwardRef(
  (props, forwardedRef) => {
...
var SelectScrollUpButton = React15.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React15.useState(false);
...
var SelectScrollDownButton = React15.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React15.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll22 = function() {
...
var SelectScrollButtonImpl = React15.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React15.useRef(null);
  const getItems = useCollection(__scopeSelect);
  const clearAutoScrollTimer = React15.useCallback(() => {
...
var SelectBubbleInput = React15.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const timerRef = React15.useRef(0);
  const handleTypeaheadSearch = React15.useCallback(
    (key) => {
  ...
  const resetTypeahead = React15.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React15.useEffect(() => {
